...
@testset "Utility" begin
    ...
    @testset "Interpolation" begin
        ...
        begin # spherical interpolation
            ...
            @test isnan(Afunc(SA[0, 0, 0]))  # outside domain -> NaN with bc=1
