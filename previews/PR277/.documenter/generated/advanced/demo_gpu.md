...
# title: GPU Ensemble tracing {#title:-GPU-Ensemble-tracing}

# id: demo_gpu_ensemble {#id:-demogpuensemble}
...
# julia: 1.10.3 {#julia:-1.10.3}

# description: Tracing multiple charged particles in a static EM field using GPU {#description:-Tracing-multiple-charged-particles-in-a-static-EM-field-using-GPU}

# –- {#–-2}

This example demonstrates the usage of GPU for [ensemble tracing](@ref%20demo_ensemble). Since GitHub Actions do not have GPU runners for now, we do not show the results on page.
