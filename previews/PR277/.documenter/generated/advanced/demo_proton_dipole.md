...
title: Magnetic dipole id: demo_dipole date: 2023-04-20 author: &quot;[Hongyang Zhou](https://github.com/henry2004y)&quot; julia: 1.9.0 description: Tracing charged particle in a static analytic dipole magnetic field –-
...
![](yqztcmo.png){width=600px height=450px}
...
This is much more accurate, at the cost of more iterations. In terms of accuracy, this is roughly equivalent to `solve(prob, Vern9(); reltol=1e-7)`; in terms of performance, it is 2x slower (0.04s v.s. 0.02s) and consumes about the same amount of memory 42 MiB. We can also use the classical [Boris method](https://www.particleincell.com/2011/vxb-rotation/) implemented within the package:
