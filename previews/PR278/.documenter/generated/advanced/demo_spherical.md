...
title: Tracing in spherical coordinates id: demo_spherical_B date: 2025-11-25 author: &quot;[Hongyang Zhou](https://github.com/henry2004y)&quot; julia: 1.12.2 description: Simple proton trajectory under uniform B defined in spherical coordinates. –-

This example demonstrates a single proton motion under a uniform B field defined in spherical coordinates following the same values in [Demo: Helix motion](@ref%20demo_uniformB_zeroE). The E field is set to zero.
...
![](vpnwstb.png){width=600px height=450px}
