...
title: Current sheet id: demo_currentsheet date: 2024-04-09 author: &quot;[Hongyang Zhou](https://github.com/henry2004y)&quot; julia: 1.11.4 description: Tracing charged particle in the Harris current sheet –-

This example shows how to trace protons in a stationary magnetic field that corresponds to the 1D Harris current sheet defined by a reference strength and width. A Wiki reference can be found [here](https://en.wikipedia.org/wiki/Current_sheet).
...
![](xdjwrmy.png){width=600px height=450px}
