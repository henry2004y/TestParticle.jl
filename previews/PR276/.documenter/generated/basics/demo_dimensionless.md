...
title: Dimensionless Units id: demo_dimensionless date: 2025-03-19 author: &quot;[Hongyang Zhou](https://github.com/henry2004y)&quot; julia: 1.11.4 description: Tracing charged particle in dimensionless units –-

This example shows how to trace charged particles in dimensionless units. After normalization, $q=1, B=1, m=1$ so that the gyroradius $r_L = mv_\perp/qB = v_\perp$. All the quantities are given in dimensionless units: if the magnetic field is homogeneous and the initial perpendicular velocity $v_{\perp 0}^\prime$ is 4, then the gyroradius is 4. To convert them to the original units, $v_\perp = v_{\perp}^\prime * U_0$ and $r_L = r_L^\prime * l_0 = 4*l_0$. Check [Demo: single tracing with additional diagnostics](@ref%20demo_savingcallback) and [Demo: Dimensionless and Dimensional Tracing](@ref%20demo_dimensionless_dimensional) for explaining the unit conversion.
...
![](sfaevie.png){width=600px height=450px}
...
![](xmvkfwg.png){width=600px height=450px}
...
![](dotdpxe.png){width=600px height=450px}
