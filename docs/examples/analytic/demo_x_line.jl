...
## Parameters
const B₀ = 20.0e-9  # Asymptotic magnetic field [T]
const Bₙ = 1.0e-9   # Normal magnetic field gradient parameter [T]
...
function plot_B!(ax)
    ...
    return arrows!(ax, ps, B, fxaa = true, color = Bmag, lengthscale = 0.4, arrowsize = 0.05)
end
