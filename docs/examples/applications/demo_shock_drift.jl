...
ax = Axis3(f[1, 1], title="Shock Drift Acceleration", xlabel="x [km]", ylabel="y [km]", zlabel="z [km]", aspect=:data)
...
# Plot Heavy Electrons (Yellow/Gold)
for sol in sols_e
   lines!(ax, sol, idxs=(1, 2, 3), color=:gold, linewidth=1.5)
end

# Draw Shock Plane
mesh!(ax, Rect3f(Point3f(-10e3, -1000e3, -1000e3), Vec3f(20e3, 2000e3, 2000e3)), color=(:red, 0.3))
