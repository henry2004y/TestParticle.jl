...
## Choice of numerical algorithms {#Choice-of-numerical-algorithms}
...
## Tracing backwards in time {#Tracing-backwards-in-time}
...
## Multiple particles tracing {#Multiple-particles-tracing}
...
## Guiding center drifts {#Guiding-center-drifts}
...
### Summary of guiding center drifts {#Summary-of-guiding-center-drifts}
...
## Adiabatic Invariants {#Adiabatic-Invariants}
...
## Solution Interpolations {#Solution-Interpolations}
