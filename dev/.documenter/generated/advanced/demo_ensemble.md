...
title: Ensemble tracing id: demo_ensemble date: 2024-01-23 author: &quot;[Hongyang Zhou](https://github.com/henry2004y)&quot; julia: 1.10.0 description: Tracing multiple charged particles in a static EM field –-
...
![](wjoxset.png){width=600px height=450px}

We can also solve this problem with the native [Boris pusher](@ref%20demo_boris). Note that the Boris pusher requires a additional parameters: a fixed timestep, and an output save interval.
...
![](noqlvgg.png){width=600px height=450px}
